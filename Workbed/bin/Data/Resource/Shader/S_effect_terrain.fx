...
{
	float4 influenceColor = DiffuseTexture.Sample(linearSampling, input.Tex);
	...
	float lerp4Last = baseWeight * splatBase.a + baseWeight;
	float lerp4Current = alphaWeight * splatA.a + alphaWeight;
	float lerp4Compare = saturate((lerp4Last - lerp4Current) / blendThreshold);
	float3 lerp4 = lerp(splatA.rgb, splatBase.rgb, lerp4Compare);

	float lerp3Current = blueWeight * splatB.a + blueWeight;
	...
	float lerp2Current = greenWeight * splatG.a + greenWeight;
	...
	float lerp1Current = redWeight * splatR.a + redWeight;
	...
	lerp4Last = baseWeight * splatBase.a + baseWeight;
	lerp4Current = alphaWeight * splatA.a + alphaWeight;
	lerp4Compare = saturate((lerp4Last - lerp4Current) / blendThreshold);
	lerp4 = lerp(splatA.rgb, splatBase.rgb, lerp4Compare);

	lerp3Current = blueWeight * splatB.a + blueWeight;
	...
	lerp2Current = greenWeight * splatG.a + greenWeight;
	...
	lerp1Current = redWeight * splatR.a + redWeight;
